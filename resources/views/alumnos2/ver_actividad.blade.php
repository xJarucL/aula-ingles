...
<div class="container">
    ...
    @php
        ...
        // CORRECCIÓN: Buscar preguntas en TODAS las ubicaciones posibles
        $preguntas = [];
        $ejercicios = [];
        ...
        if (is_array($contenido)) {
            ...
            // Para COMPLETAR - buscar en todas las ubicaciones
            if ($tipo === 'completar') {
                ...
                @foreach($ejercicios as $index => $ejercicio)
                    <div class="exercise-card">
                        ...
                        @php
                            ...
                            // Reemplazar guiones bajos con campo de entrada
    ...
    @else
        <!-- DEBUG: Mostrar información del contenido -->
        <div class="exam-container">
