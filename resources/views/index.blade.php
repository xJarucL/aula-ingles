...
@section('content')
<div class="container">
    <h2 style="color:#1E847D; font-family: Montserrat, Verdana, Helvetica, sans-serif; font-size:2.2rem; text-align:center; margin-bottom: 18px; letter-spacing:1px;">
    ...
    <div class="activity-test">
        ...
        <form id="quizForm">
            ...
            <div class="navigation" style="display:flex;justify-content:space-between;align-items:center;margin-top:22px;">
                <button type="button" id="prevBtn" style="display:none;background:#eee;color:#1E847D;border:none;padding:10px 24px;border-radius:7px;cursor:pointer;font-size:1rem;font-family:Montserrat;font-weight:600;" onclick="cambiarPregunta(-1)">
                    Anterior
                </button>
                <div id="nextBtnContainer" style="flex:1;display:flex;justify-content:flex-end;">
                    <button type="button" id="nextBtn" style="background:linear-gradient(90deg,#1E847D 60%,#2CA6A4 100%);color:#fff;border:none;padding:10px 24px;border-radius:7px;cursor:pointer;font-size:1rem;font-family:Montserrat;font-weight:600;" onclick="cambiarPregunta(1)">
                        Siguiente
                    </button>
                </div>
                <button type="button" id="submitBtn" style="display:none;background:linear-gradient(90deg,#1E847D 60%,#2CA6A4 100%);color:#fff;border:none;padding:10px 24px;border-radius:7px;cursor:pointer;font-size:1rem;font-family:Montserrat;font-weight:600;" onclick="mostrarResultados()">
                    Enviar respuestas
                </button>
            </div>
        </form>
...
@push('styles')
<style>
    /* Estilos específicos del examen */
    .container {
        margin-top: 60px;
    }
